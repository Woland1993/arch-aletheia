--
-- Dynamic Aletheia Theme Menu for Elephant/Walker
--
Name = "aletheiathemes"
NamePretty = "Aletheia Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/aletheia/themes"
  local aletheia_path = os.getenv("ALETHEIA_PATH") or ""
  local default_theme_dir = aletheia_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "aletheia-theme-set " .. theme_name,
            },
          })
        end
      end
